    ...
    'N/DB': function (e, t) {
      const n = 'undefined' != typeof globalThis && globalThis,
        ...
        a = function (e, ...t) {
          ...
          let n = i(e[0], e.raw[0]);
          for (let o = 1; o < e.length; o++) n += t[o - 1] + i(e[o], e.raw[o]);
          return n;
        };
      function i(e, t) {
        return ':' === t.charAt(0)
        ...
        (r =
          ...
          typeof (o = function () {
            ...
            !(function (e) {
              ...
              let O = { parent: null, zone: new i(null, null) },
                j = null,
                I = 0;
              function N() {}
              ...
              Zone.__load_patch('ZoneAwarePromise', (e, t, n) => {
                ...
                function T(e, o, s) {
                  ...
                  if (null === e[g]) {
                    ...
                    if (!1 !== o && s instanceof D && s.hasOwnProperty(g) && s.hasOwnProperty(k) && null !== s[g])
                      w(s), T(e, s[g], s[k]);
                ...
                class D {
                  ...
                  then(e, n) {
                    ...
                    const r = new o(S),
                      s = t.current;
                    return null == this[g] ? this[k].push(s, r, e, n) : Z(this, s, r, e, n), r;
                  }
                  catch(e) {
                    ...
                    o[_] = _;
                    const r = t.current;
                    return null == this[g] ? this[k].push(r, o, e, e) : Z(this, r, o, e, e), o;
                  }
                }
                ...
                (C && !C.configurable) ||
                  ...
                  (C.set = function (t) {
                    t === D ? (e[z] = t) : ((e[c] = t), t.prototype[l] || j(t), n.setNativePromise(t));
                  }),
                  r(e, 'Promise', C)),
                  (e.Promise = D);
                const O = s('thenPatched');
                function j(e) {
                  const t = e.prototype,
                    n = o(t, 'then');
                ...
                (s.set = function (e) {
                  ...
                  t || n !== f || (t = f),
                    t &&
                      ...
                      c && c.apply(t, d),
                      'function' == typeof e ? ((t[h] = e), t.addEventListener(l, T, !1)) : (t[h] = null));
                }),
                (s.get = function () {
                  let e = this;
            ...
            function I() {
              ...
              try {
                const e = p.navigator.userAgent;
                (-1 === e.indexOf('MSIE ') && -1 === e.indexOf('Trident/') && -1 === e.indexOf('Edge/')) || (O = !0);
              } catch (e) {}
              return O;
            }
                ...
                const P = p
                  ...
                  A = function (t, n, r, s, a = !1, i = !1) {
                    return function () {
                      ...
                      const _ = !!d && ('boolean' == typeof d || d.capture),
                        y = !(!d || 'object' != typeof d) && d.once,
                        T = Zone.current;
                      let E = x[l];
                      E || (H(l, v), (E = x[l]));
                      const w = E[_ ? 'true' : 'false'];
                      let Z,
                        S = c[w],
                        P = !1;
                      if (S) {
                        if (((P = !0), k)) for (let e = 0; e < S.length; e++) if (O(S[e], u)) return;
                      } else S = c[w] = [];
            ...
            function oe(e, t) {
              ...
              if (y) {
                ...
                ne(e, ee.concat(['messageerror']), r ? r.concat(t) : r, n(e)),
                  ...
                  ne(HTMLFrameSetElement.prototype, q.concat(V), r),
                  ne(HTMLBodyElement.prototype, q.concat(V), r),
                  ne(HTMLFrameElement.prototype, $, r),
                  ne(HTMLIFrameElement.prototype, $, r);
                  ...
                  (n.args[0] = function () {
                    try {
                      ...
                      (t.data && t.data.isPeriodic) ||
                        ('number' == typeof n.handleId ? delete a[n.handleId] : n.handleId && (n.handleId[re] = null));
                    }
                  }),
                ...
                (s = D(
                  ...
                  (t) =>
                    function (n, o) {
                      const r = o[0];
                      let s;
                      'number' == typeof r ? (s = a[r]) : ((s = r && r[re]), s || (s = r)),
                        s && 'string' == typeof s.type
                          ? 'notScheduled' !== s.state &&
                            ((s.cancelFn && s.data.isPeriodic) || 0 === s.runCount) &&
                            ('number' == typeof r ? delete a[r] : r && (r[re] = null), s.zone.cancelTask(s))
                          : t.apply(e, o);
                    }
                ));
            }
