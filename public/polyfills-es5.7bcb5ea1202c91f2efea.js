  ...
  [3],
  {
              ...
              function (t, o) {
                ...
                for (var m = 0, k = 0, E = []; k < p.length; ) {
                  ...
                  if (null === x || (S = v(s(y.lastIndex + (d ? 0 : k)), p.length)) === m) k = u(p, k, g);
                    ...
                    for (var w = 1; w <= x.length - 1; w++) if ((E.push(x[w]), E.length === b)) return E;
                    k = m = S;
                  }
                }
    ...
    LPSS: function (t, e, n) {
      ...
      (v && d) ||
        ...
        'process' == u(g)
          ...
          : !a.addEventListener || 'function' != typeof postMessage || a.importScripts || c(w)
          ? (r =
    ...
    'N/DB': function (t, e) {
      ...
      (n || i || r || o).$localize = function t(e) {
        ...
        for (var c = a(e[0], e.raw[0]), u = 1; u < e.length; u++) c += r[u - 1] + a(e[u], e.raw[u]);
        return c;
      };
    },
    NBAS: function (t, e, n) {
          ...
          typeof (r = function () {
            ...
            !(function (t) {
              ...
              Zone.__load_patch('ZoneAwarePromise', function (t, e, n) {
                ...
                (j && !j.configurable) ||
                  ...
                  (j.set = function (e) {
                    e === T ? (t[I] = e) : ((t[u] = e), e.prototype[s] || R(e), n.setNativePromise(e));
                  }),
                  o(t, 'Promise', j)),
                  (t.Promise = T);
                var P,
                      ...
                      if (!d || d(e, f, u, arguments)) {
                        ...
                        if (R)
                          for (var y = 0; y < R.length; y++)
                            if (s === R[y]) return h ? e.call(u, s, f, v) : e.apply(this, arguments);
                        ...
                        var _,
                          ...
                          j = !1;
                        if (I) {
                          if (((j = !0), g)) for (var P = 0; P < I.length; P++) if (D(I[P], f)) return;
                        } else I = u[T] = [];
                        ...
                        var z = p ? C : void 0;
                        z && (z.taskData = S);
                        var U = x.scheduleEventTask(_, f, z, o, i);
                        return (
                          (S.target = null),
                          z && (z.taskData = null),
                          k && (v.once = !0),
            ...
            function ot(t, e) {
              if ((!b || k) && !Zone[t.symbol('patchEvents')]) {
                ...
                if (m) {
                  var i = window,
                    a = R ? [{ target: i, ignoreProperties: ['error'] }] : [];
            ...
            Zone.__load_patch('util', function (n, i, a) {
              (a.patchOnProperties = w), (a.patchMethod = O), (a.bindArguments = d), (a.patchMacroTask = I);
